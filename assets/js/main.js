    ...
    if (fünf.checked) {
        ...
        if (count < fünf.value) {
            if (comp === event.target.id) {
                ...
                resultParagraph.innerHTML = `It is a draw. You both chose ${event.target.id.toUpperCase()}`
            } else if (event.target.id === 'rock' && comp === 'paper') {
                cScore += 1
                compScore.innerHTML = cScore;
                resultParagraph.innerHTML = `${comp.toUpperCase()} (Comp) beats ${event.target.id.toUpperCase()} (You). Computer wins.`
                rock.style.borderColor = 'red'
            } else if (event.target.id === 'rock' && comp === 'scissors') {
                uScore += 1
                userScore.innerHTML = uScore;
                resultParagraph.innerHTML = `${event.target.id.toUpperCase()} (You) beat  ${comp.toUpperCase()}(Comp). You win.`
            ...
            if (comp === event.target.id) {
                ...
                compScore.innerHTML = cScore;
                if (uScore === cScore) {
                    resultParagraph.innerHTML = `Nobody Wins. It is a draw!`
                } else if (uScore > cScore) {
                    resultParagraph.innerHTML = `You Win. Score ${uScore}:${cScore}`;
                ...
                if (uScore === cScore) {
                    ...
                    resultParagraph.innerHTML = `You Wins. Score ${uScore}:${cScore}`;
                    document.body.style.background = 'limegreen'
                } else {
                    resultParagraph.innerHTML = `Computer Wins. Score ${uScore}:${cScore}`;
                    document.body.style.background = 'tomato'
